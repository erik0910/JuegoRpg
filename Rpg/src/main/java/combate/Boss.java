...
public class Boss extends Objeto  {
	...
	static final ClassLoader loader = Boss.class.getClassLoader();
...
//			arco.cargaImagen(ImageIO.read(loader.getResource("combate/disparo2.png")));
		...
		/*Imagenes===================================================*/
		try {
			BufferedImage hoja =ImageIO.read(loader.getResource("combate/Boss.png")) ;
			/*======================================================*/
	...
	public void ataque(Boss jugador) {
