...
public class ClientApp extends JFrame {
	...
	final WebTarget usersTarget = appTarget.path("players");
	...
	public ClientApp() {
		...
		final DefaultListModel<Player> userListModel = new DefaultListModel<>();
		JList<Player> userList = new JList<>(userListModel);
		...
		getUsersButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				List<Player> users = usersTarget.request(MediaType.APPLICATION_JSON).get(genericType);
