...
public class Mejoras extends JFrame {
	...
	public Mejoras() {
		...
		btnDefensa.setIcon(new ImageIcon(Mejoras.class.getResource("escudo.png")));
		...
		btnAtaque.setIcon(new ImageIcon(Mejoras.class.getResource("espada.png")));
		...
		btnEnergia.setIcon(new ImageIcon(Mejoras.class.getResource("rayo.png")));
